class FirebaseGameUser {
    ...
    constructor(idTbody) {
      ...
      this.URL = "https://api-rest-a46f2-default-rtdb.firebaseio.com/api/users";
    }
    ...
    setTableUser(data) {
        ...
        for (const user in data) {
          ...
          btnActions = '<div class="btn-group " role="group" aria-label="Basic mixed styles example">' +
            '<button type="button" onclick="showUser(' + getId + ')" class="btn btn-success"><img class="img img-fluid" src="./assets/img/icons/eye.svg"></button>' +
            '<button type="button" onclick="editUser(' + getId + ')" class="btn btn-warning"><img class="img img-fluid" src="./assets/img/icons/edit.svg"></button>' +
            '<button type="button" onclick="deleteUser(' + getId + ')" class="btn btn-danger"><img class="img img-fluid" src="./assets/img/icons/trash-2.svg"></button>' +
            '</div>';
          rowTable += "<tr>" +
            "<td>" + contRow + "</td>" +
